...
class ViewController: UIViewController {
    ...
    private func updateGameScore(forPlayer player: Player) {
        if let playerWithAdvantage = match.currentGame.playerWithAdvantage, playerWithAdvantage == player {
                playerGameScoreLabels[player]!.text = "A"
        } else if let gameScore = match.currentGame.scores[player] {
